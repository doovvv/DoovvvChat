...
Q_CONSTINIT static const qt_meta_stringdata_CLASSHttpMgrENDCLASS_t qt_meta_stringdata_CLASSHttpMgrENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 13),  // "SigHttpFinish"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 5),  // "ReqId"
        QT_MOC_LITERAL(29, 5),  // "reqId"
        QT_MOC_LITERAL(35, 3),  // "res"
        QT_MOC_LITERAL(39, 10),  // "ErrorCodes"
        QT_MOC_LITERAL(50, 3),  // "err"
        QT_MOC_LITERAL(54, 7),  // "Modules"
        QT_MOC_LITERAL(62, 3),  // "mod"
        QT_MOC_LITERAL(66, 15),  // "SigRegModFinish"
        QT_MOC_LITERAL(82, 14)   // "SlotHttpFinish"
    },
    "HttpMgr",
    "SigHttpFinish",
    "",
...
void HttpMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->SigHttpFinish((*reinterpret_cast< std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<ErrorCodes>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<Modules>>(_a[4]))); break;
        case 1: _t->SigRegModFinish((*reinterpret_cast< std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<ErrorCodes>>(_a[3]))); break;
        case 2: _t->SlotHttpFinish((*reinterpret_cast< std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<ErrorCodes>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<Modules>>(_a[4]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &HttpMgr::SigHttpFinish; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &HttpMgr::SigRegModFinish; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
